...
?>
	<div align="center">
	<div id="headtable" style="background-color: #a2d9ff;"><b><? echo $title; ?></b></div>
	<?
	//-----------------------------------------------------------------
	...
	<table id="myTable" class="tablesorter" cellspacing="1" width="100%">
		...
		while($i<$max){
			...
			if($_GET['p']=='room_list'){ 
				...
				}elseif($rows[$i][6]=='reserved'){
					$bg='style="background-color:#ff8f8f;"';
				}else{
					$bg=null;
				}
				unset($rows[$i][6]);
			}elseif($_GET['p']=='reservation_list'){ 
				if($rows[$i][7]=='booked'){
					$bg='style="background-color:#fff478;"';
				}elseif($rows[$i][7]=='reserved'){
					$bg='style="background-color:#ff8f8f;"';
				}else{
					$bg=null;
				}
	...
	<?
	page_number(); //page number for jquery table sorter
	?>
<?
}
//-----------------------------------------------------------------
